...
| [0031](./0031-extension-hooks.md) | Extension hooks: opt-in in-process Go hooks on the write lifecycle of generated endpoints (+ custom routes), Tx-participating and identity-safe, handed a narrow store interface; values-not-shape guardrail; RPC/WASM transports and a marketplace explicitly deferred | Proposed |
